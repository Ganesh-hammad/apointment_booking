...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className=' m-5 w-full'>
            ...
            <div className="bg-white p-8 border wo-full max-w-4xl max-h-[80vh] overflow-scroll ">
                ...
                <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
                    <div className="w-full lg:flex-1 flex-col gap-4">
                        ...
                        <div className="flex-1 flex flex-col gap-2">
                            <p>Experinence</p>
                            <select onChange={(e) => setExperience(e.target.value)} className='border rounded px-3 py-2' value={experience}  name="" id='' >
                ...
                <button type='submit' className='bg-parimary px-8 py-3 text-white rounded-full text-sm mt-4'>Add doctor</button>
